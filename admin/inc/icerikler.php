...
<article class="module width_3_quarter" style="padding-bottom:20px;width:95%;">
		...
		<h3 class="tabs_involved">İÇERİK LİSTESİ</h3>
		</header>
		...
		$query=query("SELECT * FROM konular INNER JOIN  uyeler ON uyeler.uye_id=konular.konu_ekleyen INNER JOIN kategoriler ON kategoriler.kategori_id=konular.konu_kategori WHERE konu_onay=1 ORDER BY konu_id DESC");
