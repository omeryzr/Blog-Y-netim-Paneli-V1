...
<div id="genel">
	...
	<div id="header">
		...
		<div class="logo">
			<a href="<?php echo URL;?>/index.php">
				<img src="<?php echo TEMA_URL;?>/images/logo1.png" alt="logo" />
			</a>
		</div>
		<!--#Logo -->
		...
		<div id="hMenu">
			<ul>
				<li class="m1 aktif"><a href="#">Anasayfa</a></li>
			...
			<div class="sagBlok">
				<div class="aboneOl">
					...
					<div class="aboneInput">
						<span>
							<input type="text" name="abone" placeholder="E-posta adresinizi yazın ve Enter tusuna basın..." />
						</span>
					</div>
				</div>
			</div>
			...
			<div class="sagBlok son">
				<div class="herGun">
					<ul>
						<li>
							<a href="#">
								<img src="<?php echo TEMA_URL;?>/images/userpic.png" alt=""/>
							</a>
						</li>
						<li>
							<a href="#">
	...
	<div id="footer">
		...
		<div class="fSag">
			<p>Tasarım: <a href="">Anonim</a></p>
			<p style="padding-top: 3px">CSS: <a href="">Anonim</a></p>
		</div>
